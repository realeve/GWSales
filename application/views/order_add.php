									...
									<div class="form-body">
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="tab2">
												...
												<div class="form-group">
													<label class="control-label col-md-3">联系人 <span class="required">
													* </span>
													</label>
													<div class="col-md-4">
												...
												<div class="form-group">
													<label class="control-label col-md-3">付款条件 <span class="required">
													* </span>
													</label>
													<div class="col-md-4">
														<div class="radio-list">
															<label>
															<input type="radio" name="paid" value="Paid" data-title="Paid"/>
															款到发货 </label>
															<label>
															<input type="radio" name="paid" value="Unpaid" data-title="Unpaid"/>
															直接发货 </label>
														</div>
														<div id="form_paid_error">
														</div>
													</div>
												</div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">省/市/自治区 <span class="required">
													* </span>
                                                    </label>
                                                    <div class="col-md-4">
												...
												<div class="form-group">
													<label class="control-label col-md-3">地区/街道 <span class="required">
													* </span>
													</label>
													<div class="col-md-4">
